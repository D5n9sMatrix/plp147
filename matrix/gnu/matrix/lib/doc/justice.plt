...
set output '/home/denis/CEO2/plp147/gnu/matrix/img/ppm61.png'
set format x "%2.0f" 
set format y "%3.2f" 
set key fixed right top vertical Right noreverse enhanced autotitle box lt black linewidth 1.000 dashtype solid
set label 1 "mu" at 4.25000, 0.0239117, 0.00000 left norotate back nopoint
set label 2 "sigma" at 6.03536, 0.135531, 0.00000 left norotate back nopoint
set arrow 1 from 3.75000, 0.00000, 0.00000 to 3.75000, 0.223452, 0.00000 nohead back nofilled linewidth 1.000 dashtype solid
set arrow 2 from 3.75000, 0.135531, 0.00000 to 5.53536, 0.135531, 0.00000 nohead back nofilled linewidth 1.000 dashtype solid
set samples 200, 200
set style data lines
set ytics  norangelimit 0.00000,0.0239117,0.239117
set title "binomial PDF using normal approximation" 
set xlabel "k, x ->" 
set xrange [ -2.00000 : 12.0000 ] noreverse nowriteback
...
p = 0.15
mu = 3.75
sigma = 1.78535710713571
xmin = -1
xmax = 11
ymax = 0.239117116019606
