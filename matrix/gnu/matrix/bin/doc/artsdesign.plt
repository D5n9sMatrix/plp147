...
set output '/home/denis/CEO2/plp147/gnu/matrix/img/ppm67.png'
set format x "%2.0f" 
set format y "%3.2f" 
set key fixed right top vertical Right noreverse enhanced autotitle box lt black linewidth 1.000 dashtype solid
set label 1 "mu" at 5.83333, 0.0170962, 0.00000 left norotate back nopoint
set label 2 "sigma" at 8.81476, 0.0578888, 0.00000 left norotate back nopoint
set arrow 1 from 5.33333, 0.00000, 0.00000 to 5.33333, 0.130380, 0.00000 nohead back nofilled linewidth 1.000 dashtype solid
set arrow 2 from 5.33333, 0.0578888, 0.00000 to 8.31476, 0.0578888, 0.00000 nohead back nofilled linewidth 1.000 dashtype solid
set samples 200, 200
set style data lines
set ytics  norangelimit 0.00000,0.0170962,0.170962
set title "negative binomial PDF using gamma approximation" 
set xlabel "k, x ->" 
set xrange [ -2.00000 : 19.0000 ] noreverse nowriteback
