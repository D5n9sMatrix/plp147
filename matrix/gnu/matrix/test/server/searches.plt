...
set output '/home/denis/CEO2/plp147/gnu/matrix/img/ppm75.png'
set format x "%3.2f" 
set format y "%3.2f" 
set format z "%3.2f" 
set grid nopolar
...
set title "Histogram of 5000 random samples from a univariate\nGaussian PDF with unit variance and zero mean" 
...
plot sin(x) with steps title "scaled bin frequency", normal(x,0,1) 
