...
set output '/home/denis/CEO2/plp147/gnu/matrix/img/ppm70.png'
set format x "%2.0f" 
set format y "%3.2f" 
set key fixed right top vertical Right noreverse enhanced autotitle box lt black linewidth 1.000 dashtype solid
set label 1 "mu" at 5.50000, 0.0193014, 0.00000 left norotate back nopoint
...
set ytics  norangelimit 0.00000,0.0193014,0.193014
