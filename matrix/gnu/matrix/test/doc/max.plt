...
set output '/home/denis/CEO2/plp147/gnu/matrix/img/ppm71.png'
set dummy t, y
unset key
set arrow 1 from 0.00000, -10.0000, 0.00000 to 0.00000, 10.0000, 0.00000 nohead back nofilled lt 0 linecolor 0 linewidth 1.000 dashtype solid
set arrow 2 from -1.00000, -10.0000, 0.00000 to -1.00000, 10.0000, 0.00000 nohead back nofilled lt 0 linecolor 0 linewidth 1.000 dashtype solid
set arrow 3 from -2.00000, -10.0000, 0.00000 to -2.00000, 10.0000, 0.00000 nohead back nofilled lt 0 linecolor 0 linewidth 1.000 dashtype solid
set arrow 4 from -3.00000, -10.0000, 0.00000 to -3.00000, 10.0000, 0.00000 nohead back nofilled lt 0 linecolor 0 linewidth 1.000 dashtype solid
set arrow 5 from -4.00000, -10.0000, 0.00000 to -4.00000, 10.0000, 0.00000 nohead back nofilled lt 0 linecolor 0 linewidth 1.000 dashtype solid
set arrow 6 from -5.00000, -10.0000, 0.00000 to -5.00000, 10.0000, 0.00000 nohead back nofilled lt 0 linecolor 0 linewidth 1.000 dashtype solid
set parametric
set samples 200, 200
set style data lines
set xzeroaxis
set title "Gamma function Î“, very useful function for probability" 
set trange [ -1.00000 : 1.00000 ] noreverse nowriteback
set xlabel "x" 
set xrange [ -5.50000 : 5.00000 ] noreverse nowriteback
...
ymin = -10
ymax = 10
plot   gsampfunc(5*t,5)-6, gamma(gsampfunc(5*t,5)-6) lt 1,   for [i=5:1:-1]      gsampfunc(5*t,i)-i, gamma(gsampfunc(5*t,i)-i) lt 1,   5*gsampfunc(5*t,2), gamma(5*gsampfunc(5*t,2)) lt 1
