...
set output '/home/denis/CEO2/plp147/gnu/matrix/img/ppm63.png'
set format x "%2.0f" 
set format y "%3.2f" 
set key fixed right top vertical Right noreverse enhanced autotitle box lt black linewidth 1.000 dashtype solid
set label 1 "mu" at 2.83333, 0.0330000, 0.00000 left norotate back nopoint
set label 2 "sigma" at 5.62220, 0.0437010, 0.00000 left norotate back nopoint
set arrow 1 from 2.33333, 0.00000, 0.00000 to 2.33333, 0.127730, 0.00000 nohead back nofilled linewidth 1.000 dashtype solid
set arrow 2 from 2.33333, 0.0437010, 0.00000 to 5.12220, 0.0437010, 0.00000 nohead back nofilled linewidth 1.000 dashtype solid
set samples 200, 200
set style data lines
set ytics  norangelimit 0.00000,0.033,0.330000
set title "geometric PDF using gamma approximation" 
set xlabel "k, x ->" 
set xrange [ -2.00000 : 15.0000 ] noreverse nowriteback
set x2range [ * : * ] noreverse writeback
set ylabel "probability density ->" 
set yrange [ 0.00000 : 0.330000 ] noreverse nowriteback
